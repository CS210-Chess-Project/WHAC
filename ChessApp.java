...
public class ChessApp {
	...
	private void initialize() {
		...
		undo.setFont(new Font("Arial Black", Font.PLAIN, 24));
		undo.setText("Undo");
		...
		infoPane.add(undo);
		undo.setBounds(infoPane.getWidth()/4, infoPane.getHeight()/2 + infoPane.getHeight()/10, infoPane.getWidth()/2, infoPane.getHeight()/6);
            
        }
        
        private void startNewGame(){		
		JButton newGame = new JButton();
		newGame.setFont(new Font("Arial Black", Font.PLAIN, 12));
		...
		newGame.setBounds(infoPane.getWidth()/4, infoPane.getHeight()/2 - infoPane.getHeight()/3, infoPane.getWidth()/2, infoPane.getHeight()/6);
...
//		frame.repaint();
	...
	private void wireUpMouseListener(final BoardDisplay bd){
